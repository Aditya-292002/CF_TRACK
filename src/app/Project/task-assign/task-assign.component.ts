...
form: FormGroup
  ...
  f_M_H(array: any = []): any{ 
    for(let data of array){
      ...
      data.ESTIMATED_HOURS = ("0000" + H.toString()).slice(-4) + ':'  + ("00" + M.toString()).slice(-2);
    }   
...
f_openWarning(index: number= null,id: number = null, status: string = null){
...
f_reverseStatus(){
  this.task_list[this._selected_index].TASK_STATUS = this.old_task_list[this._selected_index].TASK_STATUS
