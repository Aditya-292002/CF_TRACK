...
export class TaxDeclarationApprovalComponent implements OnInit {
  ...
  getAllEmployee() {
    ...
    this.http
      .PostRequest(this.apiUrl.GetTaxDecalarationEmployeeList, data)
      .then(
        (res) => {
          if (res.flag) {
  ...
  GetTaxDeclrationDetailList() {
    ...
    this.http
      .PostRequest(this.apiUrl.GetTaxDeclrationApprovalDetailList, data)
      .then(
        (res) => {
          //console.log('res', res)
  ...
  f_saveFormData(drft: boolean) {
    ...
    this.http
      .PostRequest(this.apiUrl.SaveTaxDeclarationApproval, this.v_save_data)
      .then(
        (res) => {
          if (res.flag == true) {
