...
declare var $: any;
@Component({
  selector: 'app-salary-process-approve',
  templateUrl: './salary-process-approve.component.html',
  styleUrls: ['./salary-process-approve.component.css']
})
export class SalaryProcessApproveComponent implements OnInit {
  ...
  constructor(public sharedService: SharedServiceService,
   ...
   ngOnInit() {
    this.sharedService.formName = "Salary Process Approve"
  ...
  ngAfterViewInit(){    
    setTimeout(() => {
      ...
      this.GetApproveSalaryProcessDetail();
    },150)
  }
  ...
  GetApproveSalaryProcessDetail(){
    ...
    this.http.PostRequest(this.apiUrl.GetApproveSalaryProcessDetail, data).then(res => {
      if (res.flag) {
  ...
  SaveSalaryProcess(){
    ...
    if(this.form.valid){
      this.spinner = true;
        ...
        this.http.PostRequest(this.apiUrl.SaveApproveSalaryProcess, data).then(res => {
          if (res.flag) {
