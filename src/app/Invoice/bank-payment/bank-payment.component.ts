...
export class BankPaymentComponent implements OnInit {
  ...
  ngOnInit() {
    this.sharedService.formName = "Bank Payment"
  ...
  CalculateAdjustAmount(){
    ...
    this.form.get('TRXN_BASE').setValue((TRXN_AMT * this.form.getRawValue().EXCHANGE_RATE).toFixed(2));
    ...
    this.form.get('FINAL_AMT').setValue(this.pipeService.setCommaseprated(((Number(TRXN_BASE) + Number(FINAL_OTH_CHARGEAMT1) + Number(FINAL_OTH_CHARGEAMT2)- Number(TDS_AMT))).toFixed(2)))
    //this.form.get('FINAL_AMT').setValue(((TRXN_BASE - TDS_AMT - OTH_CHARGEAMT1 - OTH_CHARGEAMT2)).toFixed(2));
    //var FINAL_AMT = (Number(TRXN_BASE) + Number(OTH_CHARGEAMT1) + Number(OTH_CHARGEAMT2) - Number(TDS_AMT));
    //this.form.get('FINAL_AMT').setValue(this.pipeService.setCommaseprated((FINAL_AMT).toFixed(2)))
  }
...
f_validateFormData(){
  ...
  f_clearForm(){
    ...
    this.form.get('CURRENCY_CODE').setValue("INR");
       ...
       this.form.get('PARTY_TYPE').setValue("V");       
